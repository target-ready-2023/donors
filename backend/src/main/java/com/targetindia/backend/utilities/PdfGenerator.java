...
public class PdfGenerator {
    ...
    public  byte[] generate(String fiscalYear) throws DocumentException, IOException {
        ...
        Paragraph certificate = new Paragraph(" Certificate Number: " + generateCertificateNumber(), fontBold);
        ...
        Paragraph aboutUs = new Paragraph("\n\n\nDream School Foundation,\n323 MG Road,\nBengaluru\nPostal Code: 560023\nIndia\nEmail: dreamschool@abc.com");
        document.add(aboutUs);

        Paragraph finalPara = new Paragraph(new StringBuilder().append("\n\n Dream School Foundation's PAN Account No: 12ABD34342 \n\n").append("80G Number: DSF.12018-2019/1E823/29302").toString(), fontBold);
        finalPara.setAlignment(Element.ALIGN_CENTER);
