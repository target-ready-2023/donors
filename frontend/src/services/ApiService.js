...
export const addDonorInfo = (data) => {
    return axios.post(`${DONOR_API_BASE_URL}/add`, data);
};
  
export const addTransactionInfo = (data) => {
    return axios.put(`${DONOR_API_BASE_URL}/transaction`, data);
};

export const getDonorDetailsById = (donorEmail) => {
    return axios.get(`${DONOR_API_BASE_URL}/find`, {
        params:{
            donorEmail,
        },
    });
...
export const getallDonarDetail=()=>{
    return axios.get(`${ALL_DONOR_DETAIL_URL}/donors`)
}

export const getAllTransactionOfParticularDonor=(donorEmail)=>{
    return axios.get(`${ALL_TRANSACTION_OF_SINGLE_DONOR}/transactionsWithEmail`,{
        params:{
            donorEmail
        }
    })
...
export const getAllTransaction=()=>{
    return axios.get(`${ALL_TRANSACTION_URL}/transactions`)
}